...
public class IncomeFragment extends Fragment implements ItemsAdapterListener, ActionMode.Callback {
    ...
    private void generateIncome() {
        ...
        Disposable disposable = ((LoftApp) getActivity().getApplication()).getMoneyApi().getMoney(token,"income")
                ...
                .doAfterTerminate(new Action() {
                    @Override
                    public void run() {
                        Log.e("TAG", "Completed generate incomes");
            ...
            Disposable disposable = ((LoftApp) getActivity().getApplication()).getMoneyApi().removeItem(String.valueOf(itemId.intValue()), token)
                    ...
                    .subscribe(new Action() {
                        ...
                        public void run() throws Exception {
                            Log.e("TAG", "Completed remove incomes");
                            generateIncome();
